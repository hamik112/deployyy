...
$results=DB::query("SELECT ft_product.*,asin from ft_product,ft_asin WHERE id_asin=ft_asin.id and active=1 AND ebaylisted=1");

$template=$twig->loadTemplate('displayEbaylisted.html');
